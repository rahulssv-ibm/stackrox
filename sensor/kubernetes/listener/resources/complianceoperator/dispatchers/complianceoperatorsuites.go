...
// CompliancesDispatcher handles compliance operator rules
type ComplianceDispatcher struct{}

// NewCompliancesDispatcher creates and returns a new compliance rule dispatcher.
func NewCompliancesDispatcher() *RulesDispatcher {
