...
var (
	...
	DeploymentVolumeSearch = registerFeature("Enables search on the volume fields of deployments", "ROX_DEPLOYMENT_VOLUME_SEARCH", enabled)

	// DeploymentSecretSearch enables search on the secret fields of deployments
	DeploymentSecretSearch = registerFeature("Enables search on the secret fields of deployments", "ROX_DEPLOYMENT_SECRET_SEARCH", enabled)

	// DeploymentEnvvarSearch enables search on the environment variable fields of deployments
	DeploymentEnvvarSearch = registerFeature("Enables search on the environment variable fields of deployments", "ROX_DEPLOYMENT_ENVVAR_SEARCH", enabled)

	// SecretFileSearch enables search on the file fields of secrets
	SecretFileSearch = registerFeature("Enables search on the file fields of secrets", "ROX_SECRET_FILE_SEARCH", enabled)
