...
func Test_makeContext(t *testing.T) {
	...
	assert.Equal(t, "clientVersion", ctx.App.Version)
...
func Test_Group(t *testing.T) {
	...
	tt := NewTelemeter("test-key", s.URL, "client-id", "client-type", "version", 0, 1)
...
func Test_makeMessageID(t *testing.T) {
	tt := NewTelemeter("test-key", "url", "client-id", "client-type", "version", 0, 1)
